...
export const budgetReducer = (state: BudgetState = initialState, action: BudgetActions) => {
    ...
    if (action.type === 'add-expense'){
        ...
        const valor = createExpense(action.payload.expense)

        return {
            ...state,
            expenses: [...state.expenses, valor],
            modal: false
        }
    ...
    if(action.type === 'update-expense'){
        return{
            ...state,
            expenses: state.expenses.map((e) => e.id === action.payload.expense.id ? action.payload.expense : e),
            modal:false,
            editingId:''
        }
    }
